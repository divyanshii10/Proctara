...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await register(companyName, email, password, name);
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Create your company account</p>
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 backdrop-blur-sm">
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/login" className="text-white hover:text-amber-400 transition-colors">
              Sign in
            </Link>
          </div>
        </div>
